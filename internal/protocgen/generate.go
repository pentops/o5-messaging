...
func (cfg Config) generateFile(gen *protogen.Plugin, file *protogen.File) (*protogen.GeneratedFile, error) {
	...
	for _, service := range file.Services {
		...
		if g == nil {
			...
			g.P("// Code generated by Bprotoc-gen-go-o5-messaging . DO NOT EDIT.")
			g.P("// versions:")
...
var (
	o5MessagePkg = protogen.GoImportPath("github.com/pentops/o5-go/messaging/v1/messaging_pb")
	contextPkg   = protogen.GoImportPath("context")
	o5msgPkg     = protogen.GoImportPath("github.com/pentops/o5-messaging.go/o5msg")
)
