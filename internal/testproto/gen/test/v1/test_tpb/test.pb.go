...
func (x *GreetingMessage) GetRequest() *messaging_j5pb.RequestMetadata {
	if x != nil {
		return x.Request
	}
	return nil
...
func (x *ResponseMessage) GetRequest() *messaging_j5pb.RequestMetadata {
	if x != nil {
		return x.Request
	}
	return nil
...
var file_test_v1_topic_test_proto_rawDesc = []byte{
	...
	0x74, 0x79, 0x1a, 0x08, 0xda, 0xa2, 0xf5, 0xe4, 0x02, 0x02, 0x62, 0x00, 0x42, 0x49, 0x5a, 0x47,
	0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x70, 0x65, 0x6e, 0x74, 0x6f,
	0x70, 0x73, 0x2f, 0x6f, 0x35, 0x2d, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x69, 0x6e, 0x67, 0x2f,
	...
	0x65, 0x73, 0x74, 0x5f, 0x74, 0x70, 0x62, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
var file_test_v1_topic_test_proto_depIdxs = []int32{
	3, // 0: test.v1.topic.GreetingMessage.request:type_name -> j5.messaging.v1.RequestMetadata
	3, // 1: test.v1.topic.ResponseMessage.request:type_name -> j5.messaging.v1.RequestMetadata
